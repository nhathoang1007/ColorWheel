...
import com.jason.colorwheel.utils.*
import com.jason.colorwheel.utils.setAlpha
import com.jason.colorwheel.utils.toDegrees
import com.jason.colorwheel.utils.toRadians
import kotlin.math.*
...
open class ColorWheel @JvmOverloads constructor(
    ...
    private fun drawThumb(canvas: Canvas) {
        ...
        thumbDrawable.indicatorColor = argbEvaluator.evaluate(brightnessOffset, hsvColor.rgb, Color.BLACK) as Int
        thumbDrawable.isShowShadow = true
    ...
    fun onBrightnessChanged(offset: Float) {
